...
/**
 * This class is the Adapter called by ListPositions_Activity
 * It will manage the rows of the list of positions
 * 
 * @author jvdur_000
 *
 */
public class DataItemAdapter extends ArrayAdapter<Position> {
	 ...
	 */
	public DataItemAdapter(Activity _activity, int _resource, List<Position> _items) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		final OnClickListener listener = new OnClickListener() {
			...
			public void onClick(View v) {
				...
				//int pos = vpMap.get(v);
				GUI_Model.getInstance().setCUDPosValue(pos+1);
				
				Intent i = new Intent(activity, PositionCUD_Activity.class);
